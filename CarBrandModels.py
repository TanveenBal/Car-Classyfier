...
for brand_name in os.listdir(base_dir):
    ...
    with open(f'CarBackEnd/mappings/Car Model Mappings/{brand_name} Model map.json', 'w') as f:
    ...
    for model_name, base_model in pretrained_models.items():
        ...
        if current_accuracy > best_accuracy:
            ...
            best_model_name = f"{brand_name} Model {current_accuracy:.2f}% {model_name}.keras"
